...
public class UlidHelper {
    ...
    /**
     * Converts a String ID to UUID (manages ULID, UUID, hex)
     */
    public static UUID stringToUuid(String idString) {
        ...
        try {
            // Standard ULID format (26 characters)
            ...
            System.err.println(" ID conversion error: " + idString + " - " + e.getMessage());
            throw new IllegalArgumentException("ID invalid: " + idString, e);
        }
    }
