...
public class TeamDataInitializer implements CommandLineRunner {
    ...
    //  ADD @Lazy TO THE CONSTRUCTION MANUAL
    ...
    private void initializeEmployees() {
        ...
        Team scannerTeam = teamRepository.findByName("ROLE_SCANNER").orElse(null);  //  Add
        Team preparerTeam = teamRepository.findByName("ROLE_PREPARER").orElse(null); //  Add
