...
const refreshAllPanels = async () => {
  ...
  //  DEBUG: View all processingStage
  try {
...
.grading-panel {
  border-top: 4px solid #730d10;
}

.certification-panel {
  border-top: 4px solid #8a3e41;
}

.preparation-panel {
  border-top: 4px solid #a26f71;
}

.scanning-panel {
  border-top: 4px solid #5a0a0d;
}

.panel-header {
  padding: 20px;
  background: linear-gradient(135deg, #fdf2f2 0%, #fae6e6 100%);
  border-bottom: 1px solid #f5bfc0;
}
...
.planning-card.delai-excelsior {
  border-left-color: #5a0a0d;
  background: linear-gradient(90deg, rgba(90, 10, 13, 0.05) 0%, white 100%);
}
