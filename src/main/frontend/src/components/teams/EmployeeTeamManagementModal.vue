<template>
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-hidden flex flex-col">
      ...
      <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex justify-between items-center">
          <div class="flex items-center space-x-3">
            <div class="w-12 h-12 bg-burgundy rounded-full flex items-center justify-center text-white font-bold text-lg">
      ...
      <!-- Current Status Bar -->
      <div class="px-6 py-4 bg-gradient-to-r from-burgundy-50 to-burgundy-100 border-b border-gray-200">
        <div class="grid grid-cols-4 gap-4 text-center">
          <div>
            <p class="text-2xl font-bold text-burgundy">{{ selectedTeams.length }}</p>
            <p class="text-xs text-gray-600 font-medium">Teams Assigned</p>
          </div>
          <div>
            <p class="text-2xl font-bold text-burgundy-700">{{ highestPermissionLevel }}</p>
        ...
        <div class="flex gap-3">
          <div class="flex-1 relative">
            ...
            <input
              ...
              class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-burgundy focus:border-burgundy"
            >
          </div>
          <select
            v-model="permissionFilter"
            class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-burgundy focus:border-burgundy"
          >
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div
            ...
            :class="[
              ...
              isTeamSelected(team)
                ? 'border-burgundy bg-burgundy-50 shadow-md'
                : 'border-gray-200 hover:border-burgundy-300 hover:shadow-sm'
            ]"
          ...
          >
            <div class="flex items-start justify-between mb-3">
              <div class="flex items-center space-x-3 flex-1 min-w-0">
                <div :class="[
                  ...
                  <svg v-if="team.permissionLevel >= 8" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M5 16L3 5l5.5 5L12 4l3.5 6L21 5l-2 11H5zm14 3H5v2h14v-2z"/>
                  </svg>
                  <svg v-else-if="team.permissionLevel >= 5" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z"/>
                  </svg>
                  <svg v-else-if="team.permissionLevel >= 3" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              <input
                ...
                class="h-5 w-5 text-burgundy border-gray-300 rounded focus:ring-burgundy flex-shrink-0 mt-1"
              >
            </div>
            ...
            <div v-if="getTeamChangeType(team)" class="mt-3 pt-3 border-t border-gray-200">
              <span :class="[
                ...
                <svg v-if="getTeamChangeType(team) === 'added'" width="12" height="12" viewBox="0 0 24 24" fill="currentColor" class="mr-1">
                  <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/>
                </svg>
                <svg v-else width="12" height="12" viewBox="0 0 24 24" fill="currentColor" class="mr-1">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex space-x-3">
            ...
            <button
              ...
              class="px-5 py-2.5 bg-burgundy text-white rounded-lg hover:bg-burgundy-800 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
            >
              <Save class="w-4 h-4" />
