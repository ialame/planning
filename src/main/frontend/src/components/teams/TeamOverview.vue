<template>
  <div class="team-overview">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
      ...
      <div class="card">
        <div class="flex items-center">
          <div class="bg-burgundy-800 rounded-lg p-3 mr-4">
            <Shield class="w-6 h-6 text-white" />
          </div>
          <div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <button
          ...
          class="p-4 border border-burgundy-200 rounded-lg hover:bg-burgundy-50 transition-colors text-left"
        >
          <div class="flex items-center space-x-3 mb-2">
            <Users class="w-6 h-6 text-burgundy" />
        ...
        >
          <div class="flex items-center space-x-3 mb-2">
            <UserPlus class="w-6 h-6 text-burgundy" />
        ...
        <button
          ...
          :disabled="loading"
          class="p-4 border border-burgundy-200 rounded-lg hover:bg-burgundy-50 transition-colors text-left disabled:opacity-50"
        >
          <div class="flex items-center space-x-3 mb-2">
            <Settings class="w-6 h-6 text-burgundy" />
