...
CREATE TABLE IF NOT EXISTS `order` (
    ...
    priorite ENUM('URGENT', 'HIGH', 'MEDIUM', 'LOW') DEFAULT 'MEDIUM',
...
VALUES
(UNHEX(REPLACE(UUID(), '-', '')), 'CMD001', 25, 20, 80.00, 150.00, 'HIGH', 1, NOW(), 75, 'URGENT'),
(UNHEX(REPLACE(UUID(), '-', '')), 'CMD002', 15, 12, 80.00, 90.00, 'MEDIUM', 1, NOW(), 45, 'NORMAL'),
(UNHEX(REPLACE(UUID(), '-', '')), 'CMD003', 30, 25, 83.33, 200.00, 'HIGH', 1, NOW(), 90, 'HIGH'),
(UNHEX(REPLACE(UUID(), '-', '')), 'CMD004', 10, 8, 80.00, 60.00, 'LOW', 1, NOW(), 30, 'LOW'),
(UNHEX(REPLACE(UUID(), '-', '')), 'CMD005', 50, 40, 80.00, 350.00, 'URGENT', 1, NOW(), 150, 'URGENT');
